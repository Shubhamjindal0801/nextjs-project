            ...
            >
                    ...
                    <td className="td-price-chip-list">
                        {coin.price_change_percentage_24h > 0 ? (
                            <div className="info-flex" style={{ marginBottom: 0 }}>
                                <div className={"price-chip price-chip-list list-in-green"}>
                                    {coin.price_change_percentage_24h.toFixed(2)} %
                                </div>
                                <TrendingUpRoundedIcon className="trending-icon list-in-green trending-icon-list" />
                            </div>
                        ) : (
                            <div className="info-flex" style={{ marginBottom: 0 }}>
                                <div className="price-chip list-in-red price-chip-list red">
                                    {coin.price_change_percentage_24h.toFixed(2)} %
                                </div>
                                <TrendingDownRoundedIcon className="trending-icon red list-in-red trending-icon-list" />
                            </div>
                        )}
                    </td>
                </Tooltip>
                ...
                <td style={{ width: "fit-content" }}>
                    ...
                    >
                        {added ? (
                            <StarRoundedIcon
                                className={`${coin.price_change_percentage_24h < 0 ? "list-in-red-star" : "list-in-green-star"}`}
                            />
                        ) : (
